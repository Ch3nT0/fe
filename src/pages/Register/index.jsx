  ...
  export default function Register() {
    ...
    const handleSubmit = (event) => {
      ...
      fetch("http://localhost:8080/accounts", {
        ...
        body: JSON.stringify({ username, password, phone, fullName,email }),
      })
          ...
          <Card sx={{ minWidth: 400, maxWidth: 500, boxShadow: 4, borderRadius: 4, padding: 4 }}>
            <CardContent>
              ...
              <Box component="form" display="flex" flexDirection="column" alignItems="center" width="100%" onSubmit={handleSubmit}>
                ...
                <TextField label="Số điện thoại" variant="outlined" fullWidth margin="normal" value={phone} onChange={(e) => setPhone(e.target.value)} required/>
